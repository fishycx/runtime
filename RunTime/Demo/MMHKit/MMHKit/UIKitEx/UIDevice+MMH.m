...
#import "UIDevice+MMH.h"
#import "NSString+MMH.h"
#import "MMHKeychain.h"
#import "sys/utsname.h"

@implementation UIDevice (MMH)
...
+ (NSString *)deviceClass {
    ...
    else if ([deviceString rangeOfString:@"iPad"].location !=NSNotFound) {
        return @"iPad";
    }
    else if ([deviceString rangeOfString:@"iPod"].location !=NSNotFound) {
        return @"iPod";
    }
    else {
        return @"";
...
+ (NSString *)deviceID {
    static NSString *appBundleIdentifier = @"com.mamahao.keychain.deviceid";
    
    NSString *deviceID = (NSString *)[MMHKeychain dataForKey:appBundleIdentifier];
    ...
    if (identifierForVendor) {
        ...
        [MMHKeychain saveData:deviceID forKey:appBundleIdentifier];
        return deviceID;
    }
